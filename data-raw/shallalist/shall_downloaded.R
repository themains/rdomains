...
# Some of the data is archived here:
# https://github.com/cbuijs/accomplist/blob/master/standard.sources
...
curl_download(
  "https://raw.githubusercontent.com/cbuijs/shallalist/master/gamble/domains",
  "gambling"
)
curl_download(
...
curl_download(
  "https://raw.githubusercontent.com/cbuijs/shallalist/master/violence/domains",
  "violence"
)
...
write.csv(shalla, file = gz1, row.names = FALSE)
close(gz1)
